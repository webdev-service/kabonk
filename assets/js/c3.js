(function (global, factory) {
    ...
    ChartInternal.prototype.generateFlow = function (args) {
        ...
        return function () {
            ...
            var translateX, scaleX = 1,
                transform, flowIndex = flow.index,
                flowLength = flow.length,
                flowStart = $$.getValueOnIndex($$.data.targets[0].values, flowIndex),
                flowEnd = $$.getValueOnIndex($$.data.targets[0].values, flowIndex + flowLength),
                orgDomain = $$.x.domain(),
                domain, durationForFlow = flow.duration || duration,
    ...
    ChartInternal.prototype.updateTargetsForArc = function (targets) {
        var $$ = this,
            main = $$.main,
            mainPies, mainPieEnter, classChartArc = $$.classChartArc.bind($$),
    ...
    ChartInternal.prototype.redrawArc = function (duration, durationForExit, withTransform) {
        var $$ = this,
            ...
            config = $$.config,
            main = $$.main,
            arcs, mainArc, arcLabelLines, mainArcLabelLine, hasGaugeType = $$.hasType('gauge');
    ...
    ChartInternal.prototype.getYDomain = function (targets, axisId, xDomain) {
        ...
        var targetsByAxisId = targets.filter(function (t) {
            ...
            domain, domainLength, padding_top, padding_bottom, center = axisId === 'y2' ? config.axis_y2_center : config.axis_y_center,
            yDomainAbs, lengths, diff, ratio, isAllPositive, isAllNegative, isZeroBased = $$.hasType('bar', yTargets) && config.bar_zerobased || $$.hasType('area', yTargets) && config.area_zerobased,
        ...
        if (showHorizontalDataLabel) {
            ...
            var pixelsToAxisPadding = $$.getY(config["axis_".concat(axisId, "_type")], [0, config.axis_rotated ? $$.width : $$.height], [0, domainLength]);
    ...
    ChartInternal.prototype.drag = function (mouse) {
        ...
        main.selectAll('.' + CLASS.shapes).selectAll('.' + CLASS.shape).each(function (d, i) {
            ...
            var shape = d3.select(this),
                ...
                _x, _y, _w, _h, toggle, isWithin = false,
                box;
    ...
    ChartInternal.prototype.dataLabelFormat = function (targetId) {
        var $$ = this,
            ...
            format, defaultFormat = function defaultFormat(v) {
                return isValue(v) ? +v : '';
            };
    ...
    ChartInternal.prototype.updateGrid = function (duration) {
        var $$ = this,
            main = $$.main,
            config = $$.config,
            xgridLine, xgridLineEnter, ygridLine, ygridLineEnter, xv = $$.xv.bind($$),
            yv = $$.yv.bind($$),
    ...
    ChartInternal.prototype.generateGridData = function (type, scale) {
        var $$ = this,
            gridData = [],
            xDomain, firstYear, lastYear, i, tickNum = $$.main.select('.' + CLASS.axisX).selectAll('.tick').size();
        if (type === 'year') {
            xDomain = $$.getXDomain();
    ...
    ChartInternal.prototype.updateTargetsForBar = function (targets) {
        var $$ = this,
            config = $$.config,
            mainBars, mainBarEnter, classChartBar = $$.classChartBar.bind($$),
    ...
    ChartInternal.prototype.updateTargetsForLine = function (targets) {
        var $$ = this,
            config = $$.config,
            mainLines, mainLineEnter, classChartLine = $$.classChartLine.bind($$),
    ...
    ChartInternal.prototype.lineWithRegions = function (d, x, y, _regions) {
        var $$ = this,
            ...
            prev = -1,
            i, j, s = 'M',
            sWithRegion, xp, yp, dx, dy, dd, diff, diffx2, xOffset = $$.isCategorized() ? 0.5 : 0,
            xValue, yValue, regions = [];
    ...
    ChartInternal.prototype.updateTargetsForSubchart = function (targets) {
        var $$ = this,
            context = $$.context,
            config = $$.config,
            contextLineEnter, contextLine, contextBarEnter, contextBar, classChartBar = $$.classChartBar.bind($$),
            classBars = $$.classBars.bind($$),
    ...
    ChartInternal.prototype.drawColorScale = function () {
        var $$ = this,
            ...
            barWidth, barHeight, axis, points, legendAxis, axisScale, inverseScale, height;
        ...
        if (config.stanford_scaleFormat === 'pow10') {
            axis.selectAll('.tick text').text(null).filter(powerOfTen).text(10).append('tspan').attr('dy', '-.7em').text(function (d) {
    ...
    var pointInRegion = function pointInRegion(point, region) {
        var xi, yi, yj, xj, intersect, x = point.x,
            y = point.value,
            inside = false;
    ...
    ChartInternal.prototype.updateStanfordElements = function (duration) {
        var $$ = this,
            main = $$.main,
            config = $$.config,
            stanfordLine, stanfordLineEnter, stanfordRegion, stanfordRegionEnter, stanfordText, stanfordTextEnter, xvCustom = $$.xvCustom.bind($$),
