(function (global, factory) {
    ...
    function histogram() {
        ...
        function histogram(data) {
            ...
            if (!Array.isArray(tz)) {
                ...
                tz = sequence(Math.ceil(x0 / tz) * tz, x1, tz);
            }
            var m = tz.length;
    ...
    function drag() {
        ...
        function beforestart(id, container, point, that, args) {
            var p = point(container, id),
                s, dx, dy, sublisteners = listeners.copy();
    ...
    function brush$1(dim) {
        ...
        function started() {
            ...
            var that = this,
                ...
                s0, s1, dx = 0,
                dy = 0,
                moving, shifting = signX && signY && keys && exports.event.shiftKey,
                lockX, lockY, pointer = exports.event.touches ? toucher(exports.event.changedTouches[0].identifier) : mouse,
                point0 = pointer(that),
                point = point0,
            ...
            if (exports.event.touches) {
                ...
                var view = select(exports.event.view).on("mousemove.brush", moved, true).on("mouseup.brush", ended, true);
    ...
    function ribbon() {
        ...
        function ribbon() {
            var buffer, argv = slice$2.call(arguments),
    ...
    function nest() {
        ...
        function apply(array, depth, createResult, setResult) {
            ...
            var i = -1,
                n = array.length,
                key = keys[depth++],
                keyValue, value, valuesByKey = map$1(),
                values, result = createResult();
            while (++i < n) {
    ...
    function formatDate(date) {
        ...
        return isNaN(date) ? "Invalid Date" : formatYear(date.getUTCFullYear()) + "-" + pad(date.getUTCMonth() + 1, 2) + "-" + pad(date.getUTCDate(), 2) +
    ...
    function tree_find(x, y, radius) {
        var data, x0 = this._x0,
            y0 = this._y0,
            x1, y1, x2, y2, x3 = this._x1,
            y3 = this._y1,
            quads = [],
            node = this._root,
            q, i;
    ...
    function tree_remove(d) {
        ...
        var parent, node = this._root,
            retainer, previous, next, x0 = this._x0,
            y0 = this._y0,
            x1 = this._x1,
            y1 = this._y1,
    ...
    function link(links) {
        var id = index,
            ...
            strengths, distance = constant$7(30),
            distances, nodes, count, bias, iterations = 1;
        if (links == null) links = [];
    ...
    function manyBody() {
        var nodes, node, alpha, strength = constant$7(-30),
    ...
    function radial(radius, x, y) {
        var nodes, strength = constant$7(0.1),
            strengths, radiuses;
    ...
    var lambda0$1, phi0, lambda1, phi1, lambda2, lambda00$1, phi00$1, p0, deltaSum = adder(),
        ranges, range;
    var boundsStream = {
        point: boundsPoint,
    ...
    function linePoint(lambda, phi) {
        ...
        if (p0) {
            ...
            var delta = lambda - lambda2,
                ...
                phii, antimeridian = abs(delta) > 180;
        ...
        return {
            ...
            point: function (lambda1, phi1) {
                ...
                if (abs(delta - pi$3) < epsilon$2) {
                    ...
                    if (abs(lambda0 - sign0) < epsilon$2) lambda0 -= sign0 * epsilon$2;
    ...
    function clipAntimeridianIntersect(lambda0, phi0, lambda1, phi1) {
        ...
        return abs(sinLambda0Lambda1) > epsilon$2 ? atan((sin$1(phi0) * (cosPhi1 = cos$1(phi1)) * sin$1(lambda1) -
    ...
    function clipRectangle(x0, y0, x1, y1) {
        ...
        return function (stream) {
            var activeStream = stream,
                ...
                segments, polygon, ring, x__, y__, v__, x_, y_, v_, first, clean;
            var clipStream = {
                point: point,
                lineStart: lineStart,
                lineEnd: lineEnd,
    ...
    function projectionMutator(projectAt) {
        ...
        projection.clipExtent = function (_) {
            return arguments.length ? (postclip = _ == null ? (x0 = y0 = x1 = y1 = null, identity$4) : clipRectangle(x0 = +_[0][0], y0 = +_[0][1], x1 = +_[1][0], y1 = +_[1][1]), reset()) : x0 == null ? null : [
                [x0, y0],
                [x1, y1]
            ];
        };
    ...
    function albersUsa() {
        var cache, cacheStream, lower48 = albers(),
            lower48Point, alaska = conicEqualArea().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
            alaskaPoint, hawaii = conicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
        ...
        albersUsa.translate = function (_) {
            ...
            alaskaPoint = alaska.translate([x - 0.307 * k, y + 0.201 * k]).clipExtent([
                [x - 0.425 * k + epsilon$2, y + 0.120 * k + epsilon$2],
    ...
    function stratify() {
        ...
        function stratify(data) {
            var d, i, n = data.length,
                root, parent, node, nodes = new Array(n),
                nodeId, nodeKey, nodeByKey = {};
            for (i = 0; i < n; ++i) {
    ...
    function transformer$1() {
        var domain = unit,
            ...
            transform, untransform, unknown, clamp = identity$6,
    ...
    function transformer$2() {
        var x0 = 0,
            x1 = 1,
            t0, t1, k10, transform, interpolator = identity$6,
            clamp = false,
            unknown;
    ...
    function transformer$3() {
        var x0 = 0,
            x1 = 0.5,
            x2 = 1,
            t0, t1, t2, k10, k21, interpolator = identity$6,
            transform, clamp = false,
            unknown;
    ...
    function pie() {
        ...
        function pie(data) {
            var i, n = data.length,
                ...
                a1, p = Math.min(Math.abs(da) / n, padAngle.apply(this, arguments)),
                pa = p * (da < 0 ? -1 : 1),
                v;
            for (i = 0; i < n; ++i) {
    ...
    function link$2(curve) {
        ...
        function link() {
            var buffer, argv = slice$6.call(arguments),
                s = source.apply(this, argv),
                t = target.apply(this, argv);
            if (!context) context = buffer = path();
    ...
    function clipCells(x0, y0, x1, y1) {
        var nCells = cells.length,
            iCell, cell, site, iHalfedge, halfedges, nHalfedges, start, startX, startY, end, endX, endY, cover = true;
    ...
    function addBeach(site) {
        var x = site[0],
            directrix = site[1],
            lArc, rArc, dxl, dxr, node = beaches._;
        while (node) {
    ...
    function zoom() {
        var filter = defaultFilter$2,
            ...
            touchstarting, touchending, touchDelay = 500,
            wheelDelay = 150,
            clickDistance2 = 0;
        ...
        zoom.extent = function (_) {
            return arguments.length ? (extent = typeof _ === "function" ? _ : constant$d([
                [+_[0][0], +_[0][1]],
                [+_[1][0], +_[1][1]]
            ]), zoom) : extent;
        };
